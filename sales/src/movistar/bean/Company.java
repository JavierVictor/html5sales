...
public class Company extends Entity {
	...
	public Company(InputStream is, boolean closeStream) throws Exception {
		super(is, closeStream);
	}

	public Company(InputStream is) throws Exception {
		super(is);
	}

	public Company(byte[] bytes) throws Exception {
		super(bytes);
